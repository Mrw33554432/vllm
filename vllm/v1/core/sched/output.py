...
class NewRequestData:
    ...
    # HoleKV: hole-preserved position encoding for the model runner.
    # Set from Request.holekv_position_map when a valid HoleKV view exists.
    holekv_position_map: Any = None
    ...
    def from_request(
        ...
        # HoleKV: extract position map from request if a valid view was built.
        holekv_position_map = getattr(request, 'holekv_position_map', None)
        return cls(
            ...
            holekv_position_map=holekv_position_map,
        )
