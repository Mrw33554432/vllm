...
class SingleTypeKVCacheManager(ABC):
    ...
    def allocate_new_computed_blocks(
        ...
        # Skip when caching is disabled — HoleKV imports may supply
        # non-empty computed blocks even without prefix caching; those
        # blocks are already pinned by the scheduler.
